...
const store = applyMiddleware(promise)(createStore)(reducers, devTools) // Chama todos os Reducers para envolver a aplicação em <App /> com o <Provider> puxando essa constante
